...
export const FilterModal = ({
	...
	return (
		...
		>
			<div
				className="relative  py-10 px-8 z-50	rounded-2xl bg-white w-full max-w-[calc(100vw-80px)] "
				onClick={e => e.stopPropagation()}
			>
				<div className="relative mb-6 flex flex-row-reverse items-center justify-center ">
					<button
						onClick={onClose}
						className="cursor-pointer w-5 h-5 absolute right-0 text-gray-600 hover:text-gray-900 text-5xl font-bold "
					>
						<svg
							width="20"
							height="20"
					...
					<h2 className=" text-[2.5rem] block text-center">
						{i18next.t('Filter')}
					</h2>
				</div>
